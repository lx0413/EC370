...
<!---
# to allow for incremental bulltes in the pdf: uncomment out this css
```{css, echo = F, eval = T}
@media print {
  .has-continuation {
...
![risk-0-m](chpt6_Image/risk-0-m.png)
...
![risk-1-m](chpt6_Image/risk-1-m.png)
...
![risk-2-m](chpt6_Image/risk-2-m.png)
